      ...
      },
      {
        ...
        items: [
          { text: '工具链', 
            link: '/devopstools/',
            items: [
              {text: '分布式版本控制系统', link:'/pages/617900/'},
              {text:'docker', link:'/pages/c6c432/'},
          ...
          { text: '企业级方案',
            ...
            items: [
              {text:'devops基础', link:'/pages/40bb17//'},
              {text:'devops企业级方案', link:'/pages/0d9a92/'},
      ...
      },
      {
        ...
        items: [
          {
            text: '数据库',
            items: [
              { text: 'Mysql', link: '/pages/8aab47/' },
              { text: 'Redis', link: '/pages/3d88fa/' },
              { text: 'Mongodb', link: '/pages/7870e4/' },
              { text: 'Es', link: '/pages/2645d8/' },
            ],
        ...
        },
        {
          ...
          items:[
            ...
            {text: 'Nginx', link: '/pages/5dbe6e/'},
            {text: 'RPC', link: '/pages/6ffb53/'},
            {text: 'zabbix', link: '/pages/f7cf04/'},
            {text: 'ELK', link: '/pages/c99be3/'}
          ]
        },
        ],
      },
